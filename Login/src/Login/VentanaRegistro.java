...
public class VentanaRegistro extends javax.swing.JFrame {
    ...
    private void limpiarCajas(){
        ...
        txtNcomp.setText(null);
        txtNusuario.setText(null);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Nombre Completo"));

        txtNcomp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNcompActionPerformed(evt);
            }
        });
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try{
            ...
            ps = (PreparedStatement) conectar.prepareStatement("INSERT INTO usuarios (nombre_completo,correo_electronico,nombre_usuario,contrasena) VALUES (?,?,?,?)");
            ps.setString(1, txtNcomp.getText());
            ps.setString(2, txtCorreo.getText());
            ps.setString(3, txtNusuario.getText());
            ...
            if (res > 0){
                ...
                JOptionPane.showMessageDialog(null, "Error en Registro, Intente de Nuevo!");
                limpiarCajas();
                dispose();
            }
            conectar.close();
    ...
    private void txtNcompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNcompActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNcompActionPerformed
